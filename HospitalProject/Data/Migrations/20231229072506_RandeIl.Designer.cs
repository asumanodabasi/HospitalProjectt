...
namespace HospitalProject.Data.Migrations
{
    ...
    [Migration("20231229072506_RandeIl")]
    partial class RandeIl
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RandevuWorkingHour", b =>
                {
                    b.Property<int>("RandevusId")
                        .HasColumnType("int");

                    b.Property<int>("WorkHoursId")
                        .HasColumnType("int");

                    b.HasKey("RandevusId", "WorkHoursId");

                    b.HasIndex("WorkHoursId");

                    b.ToTable("RandevuWorkingHour");
                });
            ...
            modelBuilder.Entity("RandevuWorkingHour", b =>
                {
                    b.HasOne("HospitalProject.Models.Randevu", null)
                        .WithMany()
                        .HasForeignKey("RandevusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
